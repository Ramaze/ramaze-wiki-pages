...
Ebb aims to be a small and fast web server specifically for hosting dynamic Ruby language web applications. You can find more info at the [[http://groups.google.com/group/ebbebb][google group]]. The source code is hosted [[https://github.com/ry/ebb/tree/master][at github]].
